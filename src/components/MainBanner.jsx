  ...
  return (
    <div className='main-banner intro-wrap'>
      ...
      <p className='intro-subtitle'>
        платформа психологической поддержки, которая объединила<br />
        силу искусственного интеллекта с современными методами психотерапии.
      </p>
      <p className='intro-subtitle'>
        Наша цель - помочь тебе справиться с эмоциональным перееданием,<br />
        тревогой о весе, стрессом и негативным отношением к себе.
      </p>
      <p className='intro-subtitle'>
        В этом нам поможет нейросеть, которая каждый месяц будет составлять<br />
